...
#
#     PHX_SERVER=true bin/xwa start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :xwa, XwaWeb.Endpoint, server: true
end

config :xwa, XwaWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]
...
if config_env() == :prod do
  ...
  config :xwa, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :ueberauth, Ueberauth.Strategy.Github.OAuth,
    client_id: System.get_env("GITHUB_CLIENT_ID") || raise("GITHUB_CLIENT_ID is not set"),
    client_secret:
      System.get_env("GITHUB_CLIENT_SECRET") || raise("GITHUB_CLIENT_SECRET is not set")
